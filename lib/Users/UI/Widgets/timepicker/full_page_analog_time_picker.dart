              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      print('Fecha: ' +
                          _myPreferences.fecha.toString() +
                          'Hora: ' +
                          _myPreferences.hora.toString());
                      if (_myPreferences.fecha.toString() == 'null' ||
                          _myPreferences.hora.toString() == 'null') {
                        showDialog(
                          context: context,
                          builder: (context) => AlertDialog(
                            content: ListTile(
                              ...
                              subtitle: Text(
                                  'Debes seleccionar la fecha y hora para reservar tu servicio'),
                            ),
                            actions: <Widget>[
                              // FlatButton(
                              //   color: Colors.amber,
