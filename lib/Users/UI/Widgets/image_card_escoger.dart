...
class ImageCardEscoger extends StatelessWidget {
  String buttonText;
  String image="asset/images/background.jpg";
  MyPreferences _myPreferences = MyPreferences();
  ImageCardEscoger(this.image,this.buttonText);
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    final card= GestureDetector(
        onTap: () {
          _myPreferences.servicio = "escoge";
          _myPreferences.commit();
          Navigator.push(context, PageTransition(child: Services('Activos'), type: PageTransitionType.rightToLeft));},
        child:Container(
    ...
    final button= GestureDetector(
      onTap: () { Navigator.push(context, PageTransition(child: Services('Todos'), type: PageTransitionType.rightToLeft));},
      child: Container(
