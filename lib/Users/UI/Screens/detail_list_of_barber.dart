            ...
            children: <Widget>[
              ...
              Flexible(
                child: Container(
                  ...
                  child: Text(superHero1.title, style:
                  TextStyle(
            ...
            children: <Widget>[
              ...
              SizedBox(
                height: 70,
                      ...
                      Container(
                        child: Text(
                          superHero1.nameofbarber,style: TextStyle(
                      ...
                      Row(
                        children: <Widget>[
                          Container(
                            margin: EdgeInsets.all(19),
                            child: Text(
                              "Estudios: " + superHero1.estudiosbarber,style: TextStyle(
                                fontFamily: "Lato",
                                fontSize: 18
                            ),
                            ),
                      ...
                      Row(
                        children: <Widget>[
                          Container(
                              margin: EdgeInsets.all(19),
                              child:Text(
                                "Trabajo: " + superHero1.trabajobarber,style: TextStyle(
                                  fontFamily: "Lato",
                                  fontSize: 18
                              ),
                              )
                        ...
                        children: <Widget>[
                          Container(
                              ...
                              child:Flexible(
                                child: Container(
                                  child: Text(
                                    "Direccion: " + superHero1.direccionbarber,style: TextStyle(
                                      fontFamily: "Lato",
                                      fontSize: 18
                                  ),
                                  ),
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                              context,
                              PageTransition(child: SeleccionBarberos(), type: PageTransitionType.rightToLeft));
                        },
                        child: Container(
                          height: 50.0 ,
                          width: 210.0,
                                  ...
                                  children: <Widget>[
                                    Container(
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            Text('Califica el servicio', style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold),),
                                            Container(
                                                height: 100,
                                                width: 100,
                                    ...
                                    SizedBox(height: 5,),
                                        ...
                                        Padding(
                                          ...
                                          child: Text('Calidad del servicio:', style: TextStyle(color: Colors.black,fontSize: 16), textAlign: TextAlign.center,),
                                        ),
                                    ...
                                    Container(
                                      ...
                                      margin: const EdgeInsets.only(left: 20, top: 2, right: 20),
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                            ...
                                            hintText: 'Comentanos que tal te parecio el servicio'),
