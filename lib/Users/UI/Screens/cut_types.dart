...
class _InmediatePageState extends State<InmediatePage> {
  ...
  _InmediatePageState() {
    items.add(new MySuperHero2(
        "assets/images/cortesbarbero.jpg",
        "Corte simple",
        "No te compliques, escoge entre cualquiera de nuestros barberos aleatoriamente y agenda un corte inmediatamente ",
        5));
    items.add(new MySuperHero2(
        "assets/images/CorteClasico.jpg",
        "Corte clasico",
        "Escoge al barbero de tu preferencia y agenda unn corte con inmediatamente ",
        5));
    items.add(new MySuperHero2(
        "assets/images/EspecialBarbers.jpg",
        "Especial Barbers",
        "Reserva tu servicio para una fecha especifica y sigue su estado en el area de programadas dentro de tu perfil",
        5));
  }
    ...
    return GestureDetector(
        onTap: () {
          ...
          Navigator.push(
              context,
              PageTransition(
                  child: MyDetailPageInmediate(items[index]),
