...
import 'list_of_barbers.dart';

class SeleccionBarberos extends StatefulWidget with NavigationStates {
  @override
  State createState() {
    return _SeleccionBarberos();
  }
}

class _SeleccionBarberos extends State<SeleccionBarberos> {
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              Stack(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "Busca entre nuestros barberos afiliados y córtate con el que mas te guste.",
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (input) =>
                        input.isEmpty ? 'Ingresa una fecha válida' : null,
                    onChanged: (val) {
                      //setState(() => _email = val);
                    },
                  ),
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (input) =>
                        input.isEmpty ? 'Ingresa una hora válida' : null,
                    onChanged: (val) {
                      //setState(() => _email = val);
                    },
                  ),
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style:
                            TextStyle(fontFamily: "BAHNSCHRIFT", fontSize: 20),
                      ),
                    ),
                  )
                ],
              ...
              //     color: Color(0xffAD8B19),
              //     onPressed: () async {
              //       Navigator.push(context, PageTransition(child: Services("Todos"), type: PageTransitionType.rightToLeft));
              //     },
              //     child: Text(
              //       "Escoje tu Barbero",
              //       style: TextStyle(color: Colors.white, fontSize: 16.0,
                  ...
                  Stack(
                    children: [
                      Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: AssetImage(
                                    "assets/images/cortesbarbero.jpg",
                                  )),
                              boxShadow: <BoxShadow>[
                                BoxShadow(
                                    color: Colors.black38,
                      ...
                      Container(
                        ...
                        height: 30.0,
                        width: MediaQuery.of(context).size.width * 0.5,
                        decoration: BoxDecoration(color: Color(0xffAD8B19)),
                        child: Center(
                          child: Text(
                            "Corte simple",
                            style: TextStyle(
